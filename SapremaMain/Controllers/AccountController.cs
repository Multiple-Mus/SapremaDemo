...
using SapremaMain.Models.AccountViewModels;
...
namespace SapremaMain.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult AccountCreated(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            return View();
        }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //var foo = await _userManager.GetUserIdAsync(user);
                    //bool isCreate = new Create().CreateTeacher(user.Id, "twister studio");
                    //var ourId = new Get().GetTeacher(user.Id);
